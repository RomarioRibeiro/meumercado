...
import com.meuMercado.service.PedidoItensService;

@RestController
@RequestMapping(value = "/pedidosintens")
public class PedidoitensResource {
	@Autowired
	...
	public ResponseEntity<Void> insert (@RequestBody PedidoItens obj){
